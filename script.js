...
// Select the dropdown menu and listen for changes
...
backgroundColorSelect.addEventListener('change', function() {
    ...
    // Save the selected color to localStorage for persistence
    localStorage.setItem('selectedBackgroundColor', selectedColor);
});

// Check if there is a saved background color in localStorage
const savedBackgroundColor = localStorage.getItem('selectedBackgroundColor');
if (savedBackgroundColor) {
    // Set the background color of the body to the saved color
    document.body.style.backgroundColor = savedBackgroundColor;
    // Set the selected option in the dropdown menu to match the saved color
